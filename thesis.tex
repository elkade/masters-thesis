...
\begin{enumerate}
	\item Word2Vec z modelem\cite{pias} uczonym na korpusie S³owosieci\cite{wordnet} (model opisany jest poni¿ej) oraz odleg³oœciami miêdzy dokumentami liczonymi na bazie centroidu dokumentu.
	\item Word2Vec z modelem\cite{pias} uczonym na korpusie S³owosieci oraz odleg³oœciami miêdzy dokumentami liczonymi metod¹ Word Mover's Distance
	\item Word2Vec z modelem uczonym na korpusie oraz odleg³oœciami miêdzy dokumentami liczonymi na bazie centroidu dokumentu.
	\item Word2Vec z modelem uczonym na korpusie oraz odleg³oœciami miêdzy dokumentami liczonymi metod¹ Word Mover's Distance
	\item Latent Dirichlet Allocation
\end{enumerate}

Ponadto wyniki zastosowania powy¿szych metod porównujê z dotychczasow¹ metod¹ wykorzystywan¹ w serwisie allegro oraz z losowym wyborem artyku³ów podobnych.

\subsection{Modele Word2Vec}

\subsubsection{Model uczony na korpusie S³owosieci}

Jako podstawowy model Word2vec u¿y³em gotowego modelu\cite{pias} stworzonego m.in. przez dr in¿. M. Piaseckiego. Model ten by³ uczony na korpusie S³owosieci wer. 10. Dane przed uczeniem  przesz³y segmentacjê, lematyzacjê i ujednoznacznianie morfosyntaktyczne. U¿yte parametry uczenia Word2Vec: metoda skip gram, wekroty d³ugoœci 100, okno kontekstu wielkoœci 100.
...
Do ka¿dej z wymienionych powy¿ej metod stosujê ka¿d¹ z trzech opracowanych przez mnie miar. Wyniki zestawiam w tabelce.
...
\begin{center}
	\begin{tabular}{ | l | l | l | p{5cm} |}
		\hline
		Alias metody & mean-clicks & mean-cat & mean-users \\ \hline
		rnd & - & 0.145630871396 & \\ \hline
		crp\_wmd & 1.29748226281 & 0.542820699708 & \\ \hline
		crp\_ctr & 1.37170817357 & 0.521784904438 & \\ \hline
		pias\_wmd & 1.3817891755  & 0.54587787496 & \\ \hline
		pias\_ctr & 1.43155208802 & 0.517755911889 & \\ \hline
		lda & 1.56573051337 & 0.493703433754 & \\ \hline
		allgr & 1.14732593575 & 0.580296404276 & \\ \hline
	\end{tabular}
\end{center}

%TODO WYKRES Z WYNIKAMI PO NORMALIZACJI
...
Dla przypadku: ??? obliczenia trwa³y 55 minut, co przy czasie <1sek dla centroidu jest wartoœcia niedopuszczaln¹. Proporcjonalnie u¿ycie tej metody dla ca³ego korpusu trwa³oby ok. 183 godzin.
