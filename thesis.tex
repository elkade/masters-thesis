...
LSA dokonuje transformacji ka¿dego dokumentu w wektor cech. W tym przypadku cechami s¹ s³owa wystêpuj¹ce w dokumencie. Nastêpnie macierz zawieraj¹ca wszystkie wektory jest tworzona: kolumny reprezentuj¹ dokumenty a wiersze reprezentuj¹ unikalne s³owa. Liczba wierszy mo¿e byæ bardzo du¿a . W celu identyfikacji istotnych cech tej macierzy dokonuje siê rozk³adu SVD, który jest popularn¹ technik¹ redukcji wymiarowoœci. Celem u¿yci SVD jest redukcja liczby wierszy macierzy utrzymuj¹c jednoczeœnie podobieñstwa pomiêdzy kolumnami. Wymiar uzyskiwanej macierzy jest ustalany za pomoc¹ hiperparamtru, który oznacza liczbê tematów (topics). W tej metodzie temat sk³ada siê ze zbioru s³ów powi¹zanych z wagami definiuj¹cymi udzia³ ka¿dego ze s³ów w danym temacie. U¿ywaj¹c uzyskanej macierzy, podobieñstwo pomiêdzy kolumnami-dokumentami obliczane jest wykorzystuj¹c odleg³oœæ kosinusow¹.
...
Rozszerzeniem koncepcji word2vec jest opracowana w 2016 przez Facebook AI Research metoda fastText\cite{fast_text}. G³ówn¹ innowacj¹ tej metody jest wziêcie pod uwagê wewnêtrznej struktury s³ów. Jest to szczególnie obiecuj¹ce w przypadku bogatych morfologicznie jêzyków, mp. jêzyka polskiego.
