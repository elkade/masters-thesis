...
Testowane metody adaptuję tak, aby na~podstawie pewnego artykułu bazowego otrzymywać listę artykułów podobnych do~niego uszeregowanych pod~kątem relewantności malejąco. Takie działanie można sformalizować w~postaci funkcji 
\begin{equation}
...
%TODO:
%przeglądowy artykuł naukowy o rekomendacjach
%opisać systemy wyszukiwania
%w tekście numery wzorów
%poprawić referencję word2vec
%dlaczego taka złożoność WMD
%precyzja i zwrot po angielsku
%wykres kategorii
%przykłady znaczników z artykułów
%literówki i przecinki jeszcze raz
%paragraf z metodą clicks
%paragraf o piaseckim
%podsumowanie
%bibliografia
