...
%TODO OPISAÆ, JAK DZIA£A OBECNY MECHANIZM
...
Powy¿sze kroki doprowadzaj¹ dane do stanu, w którym mo¿na zastosowaæ techniki semantycznej analizy tekstu. Obecnie s³ownik zbudowany na korpusie zawiera 98174 s³ów. 
...
\begin{enumerate}
	...
	\item Word2Vec z modelem uczonym na ogólnym zbiorze s³ów (model opisany jest poni¿ej) oraz odleg³oœciami miêdzy dokumentami liczonymi na bazie centroidu dokumentu.
	\item Word2Vec z modelem uczonym na ogólnym zbiorze s³ów oraz odleg³oœciami miêdzy dokumentami liczonymi metod¹ Word Mover's Distance
...
Do ka¿dej z wymienionych powy¿ej metod stosujê ka¿d¹ z trzech opracowanych przez mnie miar.
