...
Rozszerzeniem koncepcji Word2vec jest opracowana w 2016 przez Facebook AI Research metoda fastText\cite{fast_text}. Metoda fastText w duøej mierze opiera siÍ na zasadzie dzia≥ania metody word2vec, a jej g≥Ûwnπ innowacjπ jest branie pod uwagÍ (w odrÛønieniu od Word2vec) rÛwnieø wewnÍtrznej struktury s≥Ûw. FastText wykorzystuje w tym celu rozbicie s≥owa na pods≥owa - ciπgi znakÛw o okreúlonej d≥ugoúci, ,,character n-grams''. Jest to szczegÛlnie obiecujπce w przypadku bogatych morfologicznie jÍzykÛw, np. jÍzyka polskiego.
