...
Autorzy metody proponuj¹ p³ytk¹, dwuwarstwow¹ sieæ neuronow¹, która ma za zadanie odtworzyæ kontekst danego s³owa i na tej podstawie dokonaæ reprezentacji s³owa jako wektora liczb rzeczywistych. Jako wejœcie metoda otrzymuje s³owa z korpusu, wyjœciem metody s¹ natomiast wektory z pewnej N wymiarowej przestrzeni odpowiadaj¹ce s³owom wejœciowym. U¿yta tu sieæ neuronowa sk³ada siê z warstw: wejœciowej, jednej warstwy ukrytej i warstwy wyjœciowej. Wyró¿nia siê dwie architektury sieci: skip-gram: na podstawie s³owa sieæ dokonuje predykcji N s¹siednich s³ów lub CBOW (continuous bag of words): na postawie okna N s¹siednich s³ów sieæ przewiduje s³owo, którego z najwiêkszym prawdopodobieñstwem te N s³ów jest s¹siedztwem. Wady i zalety obu podejœæ s¹ wymienione w \cite{google_word2vec}. W celu szczegó³owego opisu metody Word2vec wprowadzam pojêcie funkcji softmax.
